...
.Example
----
billed_unit_price{cloud="gcp",distribution="openshift4",service_level="standard",product_id="ComputeOpenShiftHyperscalerPremium"} 1.10
----
...
* Generalize example for other price models
