...
* Fluentd might be too overkill. This is unfortunately the only way when using the banzaicloud operator. It would be more lightweight to use just FluentBit → Loki. There is progress in directly supporting this mode on the Loki side, not in the banzaicloud operator though.
