...
If the tool advances and the functionality changes the name might not reflect the purpose anymore.
...
It's not always easy to detect that the purpose of a tool has changed.
