...
#The title should be CamelCase and spaces/punctuation should be replaced with -.#
...
* [.status-macro .obsolete]#obsolete# designs are kept for historical reasons, but do not reflect the current or impending state of the codebase or project.
...
What is out of scope for this SDD? Listing non-goals helps to focus discussion and make progress.
